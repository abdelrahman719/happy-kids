...
(function (f) {
    ...
    function O(a, b, c, d, e) {
        ...
        if ("-webkit-" == v) {
            ...
            a.css({ "background-image": "-webkit-gradient(linear, " + b.x + "% " + b.y + "%," + c.x + "% " + c.y + "%, " + f.join(",") + " )" });
        } else {
    ...
    var y,
        ...
        g = {
            init: function (a) {
                ...
                var d = this.data(),
                    e = this.children(),
                    a = f.extend({ width: this.width(), height: this.height(), direction: this.attr("dir") || this.css("direction") || "ltr" }, W, a);
                d.opts = a;
                d.pageObjs = {};
                d.pages = {};
                d.pageWrap = {};
                ...
                d.eventHandlers = { touchStart: f.proxy(g._touchStart, this), touchMove: f.proxy(g._touchMove, this), touchEnd: f.proxy(g._touchEnd, this), start: f.proxy(g._eventStart, this) };
            ...
            _addPage: function (a) {
                ...
                if (c)
                    if (g._necessPage.call(this, a)) {
                        if (!b.pageWrap[a]) {
                            b.pageWrap[a] = f("<div/>", { class: "page-wrapper", page: a, css: { position: "absolute", overflow: "hidden" } });
                ...
                var c,
                    ...
                    f = function (a) {
                        ...
                        e.pagePlace[a] &&
                            ...
                            e.pages[a] && (e.pages[c] = e.pages[a].flip("options", { page: c, next: h || f ? c + 1 : c - 1 })),
            ...
            display: function (a) {
                ...
                switch (a) {
                    case "single":
                        b.pageObjs[0] || (this.turn("stop").css({ overflow: "hidden" }), (b.pageObjs[0] = f("<div />", { class: "page p-temporal" }).css({ width: this.width(), height: this.height() }).appendTo(this)));
            ...
            size: function (a, b) {
                ...
                for (c in e.pageWrap)
                    n(c, e.pageWrap) && ((d = g._pageSize.call(this, c, !0)), e.pageObjs[c].css({ width: d.width, height: d.height }), e.pageWrap[c].css(d), e.pages[c] && e.pages[c].css({ width: d.width, height: d.height }));
                this.turn("resize");
                return this;
            },
            resize: function () {
            ...
            stop: function (a, b) {
                if (this.turn("animating")) {
                    ...
                    for (c = 0; c < h.pageMv.length; c++)
                        h.pageMv[c] &&
                            h.pageMv[c] !== a &&
                            ((e = h.pages[h.pageMv[c]]), (d = e.data().f.opts), e.flip("hideFoldedPage", b), b || i._moveFoldingPage.call(e, !1), d.force && ((d.next = 0 === d.page % 2 ? d.page - 1 : d.page + 1), delete d.force));
                }
                this.turn("update");
                return this;
            },
            ...
            peel: function (a, b) {
                ...
                !1 === a
                    ...
                    : ((d = "ltr" == c.direction ? (-1 != a.indexOf("l") ? d[0] : d[1]) : -1 != a.indexOf("l") ? d[1] : d[0]), c.pages[d] && c.pages[d].flip("peel", a, b));
                return this;
            },
            ...
            _eventStart: function (a, b, c) {
                ...
                a.isDefaultPrevented() ||
                    (e && e != d.zoom && (b.turn.trigger("zoomed", [b.page, b.turn.turn("view", b.page), e, d.zoom]), (d.pageZoom[b.page] = d.zoom)),
                    "single" == d.display &&
                        c &&
                        (("l" == c.charAt(1) && "ltr" == d.direction) || ("r" == c.charAt(1) && "rtl" == d.direction) ? ((b.next = b.next < b.page ? b.next : b.page - 1), (b.force = !0)) : (b.next = b.next > b.page ? b.next : b.page + 1)),
            ...
            update: function () {
                ...
                if (this.turn("animating") && 0 !== b.pageMv[0]) {
                    ...
                    for (a in b.pageWrap)
                        if (
                            n(a, b.pageWrap) &&
                            ((c = b.pageObjs[a].hasClass("fixed")), b.pageWrap[a].css({ display: d.pageV[a] || c ? "" : "none", zIndex: (b.pageObjs[a].hasClass("hard") ? d.partZ[a] : d.pageZ[a]) || (c ? -1 : 0) }), (c = b.pages[a]))
                        )
        ...
        i = {
            ...
            z: function (a) {
                var b = this.data().f;
                b.opts["z-index"] = a;
                b.fwrapper && b.fwrapper.css({ zIndex: a || parseInt(b.parent.css("z-index"), 10) || 0 });
                return this;
            },
            _cAllowed: function () {
                var a = this.data().f,
            ...
            _backGradient: function () {
                ...
                if ((b = b.opts.gradients && ("single" == b.display || (2 != a.opts.page && a.opts.page != b.totalPages - 1))) && !a.bshadow)
                    a.bshadow = f("<div/>", l(0, 0, 1)).css({ position: "", width: this.width(), height: this.height() }).appendTo(a.parent);
                return b;
            },
            type: function () {
            ...
            resize: function (a) {
                ...
                switch (b.effect) {
                    case "hard":
                        a && (b.wrapper.css({ width: d, height: e }), b.fpage.css({ width: d, height: e }), c.opts.gradients && (b.ashadow.css({ width: d, height: e }), b.bshadow.css({ width: d, height: e })));
                        break;
                    case "sheet":
                        a &&
                            ((a = Math.round(Math.sqrt(Math.pow(d, 2) + Math.pow(e, 2)))),
                            b.wrapper.css({ width: a, height: a }),
                            b.fwrapper.css({ width: a, height: a }).children(":first-child").css({ width: d, height: e }),
                            b.fpage.css({ width: d, height: e }),
                            c.opts.gradients && b.ashadow.css({ width: d, height: e }),
                            i._backGradient.call(this) && b.bshadow.css({ width: d, height: e })),
                            b.parent.is(":visible") && ((c = C(b.parent[0])), b.fwrapper.css({ top: c.top, left: c.left }), (c = C(b.opts.turn[0])), b.fparent.css({ top: -c.top, left: -c.left })),
                ...
                if (!a.wrapper)
                    switch (a.effect) {
                        ...
                        case "sheet":
                            ...
                            a.fparent ||
                                ((d = f("<div/>", { css: { "pointer-events": "none" } }).hide()), (d.data().flips = 0), d.css(l(0, 0, "auto", "visible").css).appendTo(a.opts.turn), (a.opts.turn.data().fparent = d), (a.fparent = d));
            ...
            _fold: function (a) {
                ...
                switch (b.effect) {
                    case "hard":
                        ...
                        c.opts.gradients &&
                            (g ? b.ashadow.css({ display: "", left: f, backgroundColor: "rgba(0,0,0," + 0.5 * o + ")" }).transform("rotateY(0deg)") : b.ashadow.hide(),
                    ...
                    case "sheet":
                        ...
                        var N = c.opts.acceleration,
                            ...
                            H = function () {
                                ...
                                if (
                                    ...
                                    i._backGradient.call(t) && ((A = j(100 * ((1.2 * x * Math.sin(g)) / e), 100 * ((1.2 * x * Math.cos(g)) / h))), B || (A.x = 100 - A.x), !D))
                                )
                                    A.y = 100 - A.y;
                                m.x = Math.round(m.x);
                                m.y = Math.round(m.y);
                        ...
                        f = function (a, d, f, g) {
                            var k = ["0", "auto"],
                                m = ((e - Q) * f[0]) / 100,
                                l = ((h - Q) * f[1]) / 100,
                                d = { left: k[d[0]], top: k[d[1]], right: k[d[2]], bottom: k[d[3]] },
                                k = {},
                                n = 90 != g && -90 != g ? (B ? -1 : 1) : 0,
                                r = f[0] + "% " + f[1] + "%";
    ...
    f.cssTransitionEnd = function () {
        var a,
            ...
            c = { transition: "transitionend", OTransition: "oTransitionEnd", MSTransition: "transitionend", MozTransition: "transitionend", WebkitTransition: "webkitTransitionEnd" };
